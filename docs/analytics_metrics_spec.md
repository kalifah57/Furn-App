...
> **⚠️ مُتجاوَزة جزئيًّا (2026-08):** كُتبت قبل دمج فرع المعماري على افتراض مستودع فارغ؛ بعض الـ`params` هنا مُخترَعة ولا تطابق الكتالوج الحقيقيّ في `docs/analytics_events.md`. تُقرأ كاتجاه لا كمواصفة نافذة، وسيُعاد تأسيسها على الكتالوج الحقيقيّ في G2. انظر تقرير G1: `docs/analytics_audit.md`.
>
