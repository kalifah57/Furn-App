...
- **الحالة:** مُنفَّذ (كانت «مقترح»؛ القرارات التسعة كلها مطبَّقة في الشيفرة)
- **التاريخ:** 2026-07-29 (حالة مُحدَّثة 2026-08)
- **السياق:** تطبيق **ويب** Flutter عربي-أولًا لبناء **خطة تأثيث يثق بها المستخدم**،
  mock-first، مع فصل صارم بين استخراج الـ AI (لغة وصور فقط) ومنطق المجال الحتمي
  (`domain_engine`). هذا الـ ADR يحسم النقاط المعمارية التسع. هوية المنتج في
  [`../product_thesis.md`](../product_thesis.md)، وسطح الملاحة في
  [`0002-three-experiences-navigation.md`](0002-three-experiences-navigation.md)
  — **التوصية بذرة الخطة لا المنتج.**
